...
- maybe we could add trend arrows with amount hopped in the list view?
- lets define how we call different things.
    - so for example  the list on the home page vs the item list in that page
- we should make prompts so we can update seperate places.
