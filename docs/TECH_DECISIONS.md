...
- **Tie**: Standard ELO tie handling — both sides get `actual = 0.5`. This means upset ties (low-rated ties high-rated) still shift ratings. Recorded in history as `A = B`.
