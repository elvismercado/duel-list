...
export const S = {
  ...
  history: {
    ...
    coverageValue: (seen: number, total: number) => `${seen} of ${total}`,
    streakWins: (n: number) => `${n} consecutive ${n === 1 ? 'win' : 'wins'}`,
    ...
    duelsOnDay: (n: number) => `${n} ${n === 1 ? 'duel' : 'duels'}`,
    oneSidedRecord: (wins: number, losses: number) => `${wins}\u2013${losses}`,
    vsBadge: 'VS',
    tieBadge: 'TIE',
    versusAria: 'versus',
    tieAria: 'Tie',
